  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center brand-section-soft px-4">
      <div className="text-center">
        <div className="mb-8">
          <h1 className="text-9xl font-bold text-[#0d000a]">404</h1>
          <div className="text-6xl mb-4">🔍</div>
        </div>
        <h2 className="text-3xl md:text-4xl mb-4 font-bold text-[#0d000a]">Page Not Found</h2>
        <p className="text-lg text-[#0d000a]/64 mb-8 max-w-md mx-auto">
        ...
        <div className="mt-12 pt-8 border-t max-w-md mx-auto">
          <p className="text-[#0d000a]/64 mb-4">Looking for something specific?</p>
